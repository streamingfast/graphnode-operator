...
import (
	...
	"github.com/streamingfast/graphnode-operator/controllers"
...
func init() {
	...
	utilruntime.Must(graphnodev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f405d492.streamingfast.io",
	})
	if err != nil {
